<template>
    <div style="font-family: Kanit;" class="container">
        ...
        <div class="mx-auto">
            ...
            >
                <b-navbar-brand style="font-weight: 450;"
                    >สินค้าและบริการ</b-navbar-brand
                >
            ...
            <div class="row">
                <div class="col-2">
                    <div
                        class="align-self-start p-2 bd-highlight rounded-bottom border border-primary"
                    >
                            ...
                            <div class="row">
                                ...
                                >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a
                                            v-on:click="getUrl(s_product.id)"
